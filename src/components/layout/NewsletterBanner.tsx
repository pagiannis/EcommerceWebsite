  ...
  return (
    <section className="bg-brand-black">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 py-12 lg:flex-row lg:px-8">
        <h2 className="text-3xl font-extrabold uppercase leading-tight text-white lg:max-w-sm">
          Stay upto date about our latest offers
        </h2>
        <form onSubmit={handleSubmit} className="flex w-full flex-col gap-3 sm:w-auto">
